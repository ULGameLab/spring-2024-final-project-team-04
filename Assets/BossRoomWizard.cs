...
public enum EnemyS { ATTACK, CHASE, MOVING, DEFAULT, DEAD };

[RequireComponent(typeof(UnityEngine.AI.NavMeshAgent))]
public class BossRoomWizard : MonoBehaviour
{
    ...
    Vector3 GetRandomNavMeshPosition(Vector3 center, float radius)
    {
        ...
        if (UnityEngine.AI.NavMesh.SamplePosition(randomDirection, out navMeshHit, radius, UnityEngine.AI.NavMesh.AllAreas))
        {
